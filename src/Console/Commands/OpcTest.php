...
')]
#[Description('Temporary OPC UA monitor test command (use app:monitor-opc-source for production)')]
class OpcTest extends Command
{
    ...
    public function handle(): int
    {
        ...
        $this->info('Starting OPC test monitor...');
        ...
        $this->monitorService->monitor(
            ...
            onValueChanged: function (array $event): void {
                ...
                $this->line(sprintf('  [%s] %-28s = %s', date('H:i:s'), $event['name'], $event['display']));
            },
        );
